...
const VendorVerifyOtp = () => {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: "Your vendor account has been verified. Please login.",
  ...
  const handleResendOTP = async () => {
    ...
    try {
      const response = await axios.post(`${API_BASE_URL}/vendor/resend-otp`, { email });
        ...
        <div className="signup-form-section">
          <div className="form-wrapper">
            ...
            <div className="form-group">
              ...
              <div className="otp-input-group" style={{ display: "flex", gap: "12px", justifyContent: "center", marginTop: "10px" }}>
                {otp.map((digit, index) => (
                  <input
                    key={index}
                    id={`otp-${index}`}
            ...
            <div style={{ textAlign: "center", marginTop: "15px" }}>
              <span style={{ fontSize: "14px" }}>Code expires in: <strong style={{ color: timer < 60 ? "red" : "#ff6b35" }}>{formatTime(timer)}</strong></span>
            </div>
