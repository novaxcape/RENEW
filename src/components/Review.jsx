  ...
  return (
    <div className="step-content">
      ...
      <div className="review-section">
        ...
        <div className="review-row">
          <span>Adult:</span>
          <span>NGN {pricingData.adultPrice || "Not set"}</span>
        </div>
        <div className="review-row">
          <span>Child:</span>
          <span>NGN {pricingData.childPrice || "Not set"}</span>
        </div>
        <div className="review-row">
          <span>Family Pack:</span>
          <span>NGN {pricingData.familyPackage || "Not set"}</span>
        </div>
        <div className="review-row">
      ...
      <div className="review-section">
        ...
        <div className="review-row">
          <span>Images:</span>
          <span>{imageCount || "Not set"}</span>
        </div>
        <div className="review-row">
          <span>Terms:</span>
          <span>{documents.termsAndCondition?.name || "Not set"}</span>
        </div>
        <div className="review-row">
          <span>Privacy:</span>
          <span>{documents.privacyPolicy?.name || "Not set"}</span>
        </div>
      </div>
